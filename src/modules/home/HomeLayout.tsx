      ...
      <div className={styles.banner}>
        <div className={styles.slider} style={{ '--quantity': 10 } as React.CSSProperties}>
          {[...Array(10)].map((_, i) => (
            ...
            >
              <img src={`/images/dragon_${i + 1}.${i === 0 ? 'png' : 'jpg'}`} alt={`dragon_${i + 1}`} />
            </div>
          ))}
        </div>
    ...
    {/* You can add something like a name or label here */}
      ...
      <nav className="fixed top-0 w-full z-30 bg-opacity-80 backdrop-clear-md shadow-md py-2 px-6 flex justify-between items-center">
        ...
        <div className="flex gap-4 p-4 items-center">
          <Link href="/builder">
            <StyledButton variant="text" className="neon-text">Editor</StyledButton>
          </Link>
          <Link href="#contribute">
            <StyledButton variant="text" className="neon-text">Contribute</StyledButton>
          </Link>
          <Link href="#about-us">
            <StyledButton variant="text" className="neon-text">About Me</StyledButton>
          </Link>
      ...
      <section id="contribute" className="bg-gradient-to-r from-blue-100 via-blue-50 to-white py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="mb-6">
            If you love React and design, contribute your own resume templates to our open-source project.
          </p>
          <a href="https://github.com/23CABPREMKUMARP" target="_blank" rel="noreferrer">
